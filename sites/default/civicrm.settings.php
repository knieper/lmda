...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://lmda.org:SuperSecure8@localhost/testing?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://lmda.org:SuperSecure8@localhost/testingcivi_test3?new_link=true' );
}

/*
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://lmda.org:SuperSecure8@localhost/civi_test_2?new_link=true' );
}
*/
/**
...
$civicrm_root = '/home/lmda.org/domains/testing.lmda.org/public_html/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/lmda.org/domains/testing.lmda.org/public_html/sites/default/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://www.testing.lmda.org/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '30bec7e9a0725f693d1be16a978f9f5e' );
}
...
/*if (!defined('CIVICRM_MAIL_LOG')) {
 define( 'CIVICRM_MAIL_LOG', '/home/lmda.org/domains/testing.lmda.org/public_html/sites/default/files/civicrm/templates_c//mail.log' );
 }
*/
